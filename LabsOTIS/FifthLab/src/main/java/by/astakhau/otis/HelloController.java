...
public class HelloController {
    ...
    // Поиск тензорного произведения и декартова произведения требует наличия двух графов.
    // Однако текущая реализация поддерживает только один граф.
    // Для реализации этих функций потребуется расширение приложения для поддержки нескольких графов.
